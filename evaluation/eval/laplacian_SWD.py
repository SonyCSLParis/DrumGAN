...
from ..datasets.audio_datasets import NSynthLoader
...
def test(parser, visualisation=None):
    ...
    pathDB = wholeConfig['dataConfig']["path_to_raw"]
    ...
    if os.path.splitext(pathDB)[1] == '.h5':
        ...
        dataset = AudioDataManager(**wholeConfig['dataConfig']).get_loader()
