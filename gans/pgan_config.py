...
_C.downSamplingFactor = [[1, 2], [1, 2], [1, 2], [1, 2], [1, 2], [1, 2], [1, 2], [1, 2], [1, 2]]

# This params should be in a training manager or optimizer classes
_C.mix_true_fake = False
_C.mix_true_fake_scale = -1
_C.true_fake_split = -1
_C.soft_labels = False
_C.iter_D_G_ratio = -1

_C.formatLayerType = "RandomZ" # from ['ConstantInput', 'RandomZ']
_C.generationActivation = None
